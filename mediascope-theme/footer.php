        ...
        <div class="container">
                ...
                <div class="footer-brand">
                    <a href="<?php echo esc_url(home_url('/')); ?>" class="footer-logo">
                        ...
                        if ($logo) {
                            ...
                            echo '<img src="' . esc_url($logo_url) . '" alt="' . get_bloginfo('name') . '" style="filter: brightness(0) invert(1);">';
                        } else {
                            ?>
                    ...
                    <p class="footer-about">
                        <?php echo get_theme_mod('footer_about', 'We connect brands with the world\'s most influential audiences, delivering impactful campaigns across digital, print, and experiential platforms.'); ?>
                    </p>
                </div>
                    ...
                    wp_nav_menu(array(
                        ...
                        'fallback_cb'    => function() {
                            ...
                            <ul class="footer-links">
                                ...
                                <li><a href="<?php echo esc_url(home_url('/case-study/')); ?>">Case Studies</a></li>
                            </ul>
                            <?php
                        },
                    ));
            ...
            <div class="footer-bottom">
                <p class="footer-copyright">
                    <?php 
                    echo sprintf(
                        esc_html__('© %d %s. All rights reserved.', 'mediascope'),
                        date('Y'),
                        get_bloginfo('name')
                    ); 
                    ?>
